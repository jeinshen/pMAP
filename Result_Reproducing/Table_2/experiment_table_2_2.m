function kpi_table = experiment_table_2_2(instance_amount)
...
for data_set = 1 : 6 % Iterate over all data_set
    ...
    switch data_set
        ...
        case 3
            fprintf('\n-------------------------------------------------');
            fprintf('\n Solving dataset No.3, n/m/r = 999/600/60');
            r = 60;
            Y = complex_signal_data_generator(999, 600, r, 0, instance_amount);
        case 4
            fprintf('\n-------------------------------------------------');
            fprintf('\n Solving dataset No.4, n/m/r = 999/600/80');
            r = 80;
            Y = complex_signal_data_generator(999, 600, r, 0, instance_amount);
        case 5
            fprintf('\n-------------------------------------------------');
            fprintf('\n Solving dataset No.5, n/m/r = 1999/1200/120');
            r = 120;
            Y = complex_signal_data_generator(1999, 1200, r, 0, instance_amount);
        case 6
            fprintf('\n-------------------------------------------------');
            fprintf('\n Solving dataset No.5, n/m/r = 1999/1200/160');
            r = 160;
            Y = complex_signal_data_generator(1999, 1200, r, 0, instance_amount);
    end
